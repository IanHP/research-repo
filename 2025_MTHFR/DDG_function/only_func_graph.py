...
def create_func_graph(inp, inp2, ifRoll, x_range = ()):
    ...
    ax.set_ybound((0, 660))
    ax.set_title("Rolling Average Residue Mutation Functionality Impact", fontsize=titleSize)
    ax.set_xlabel("Residue #", fontsize=titleSize)

    # create the ddg graph
    #ax.set_ylabel("ddG")
    marker_ = marker_dict["point"]
    ax.scatter([-100],[0],c="red",label="Average Fuctionality",s=36.0)
    ...
    fig.savefig("graphs/func_graph.png", bbox_inches='tight')
