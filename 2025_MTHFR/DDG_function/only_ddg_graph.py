...
def create_ddg_graph(inp, inp2, ifRoll, x_range = ()):
    ...
    ax.set_ybound((0, 660))
    ax.set_title("Rolling Average Residue Mutation ddG", fontsize=titleSize)
    ax.set_xlabel("Residue #", fontsize=labelSize)

    # create the ddg graph
    ax.set_ylabel("ddG", fontsize=labelSize)
    marker_ = marker_dict["point"]
    #ax.scatter([-100],[0],c="red",label="Fuctionality",s=36.0)
    ax.scatter(aa_res_list, y=roll_aa_ddg_list, c="#1F77B4", marker=marker_, s=36.0, label="Average ddG")
    ...
    ax.annotate('Catalytic\nDomain',xy=(120, -1.3),horizontalalignment='left', verticalalignment='top',fontsize=descSize)
    ...
    ax.annotate('Linker\nRegion',xy=(357, -1.3),horizontalalignment='left', verticalalignment='top',fontsize=descSize)
    ...
    ax.annotate('Regulatory\nDomain',xy=(500, -1.3),horizontalalignment='left', verticalalignment='top',fontsize=descSize)
    ...
    fig.savefig("graphs/ddg_graph.png", bbox_inches='tight')
